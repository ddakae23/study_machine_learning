...
noise_factor = 0.5
conv_x_train_noisy = conv_x_train + np.random.normal(loc=0.0, scale=1.0, size=conv_x_train.shape) * noise_factor
conv_x_train_noisy = np.clip(conv_x_train_noisy, 0.0, 1.0)
conv_x_test_noisy = conv_x_test + np.random.normal(loc=0.0, scale=1.0, size=conv_x_test.shape) * noise_factor
