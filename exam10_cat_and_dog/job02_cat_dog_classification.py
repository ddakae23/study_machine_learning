...
from tensorflow.keras.layers import *   ##와일드카드 케라스레이어스에 있는것 전부 사용가능함.
from tensorflow.keras.callbacks import EarlyStopping
import matplotlib.pyplot as plt

X_train, X_test, Y_train, Y_test = np.load(
'D:/work/python/pythonProject/AI_exam_prj/datasets/binary_image_data_npy.npy', allow_pickle=True)
print(X_train.shape, Y_train.shape)
print(X_test.shape, Y_test.shape)

model = Sequential()
model.add(Conv2D(32, kernel_size=(3,3), padding='same', input_shape=(64,64,3), activation='relu'))
